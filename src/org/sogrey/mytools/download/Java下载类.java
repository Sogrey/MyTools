...
public class Java下载类 implements Serializable {
     ...
     */
    public Java下载类(int downloadId, String url, String localPath) {
     ...
     * @return this
     */
    public Java下载类 setOnDownloadListener(OnDownloadListener listener) {
        mListener = listener;
        return this;
    }
